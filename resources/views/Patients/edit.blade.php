...
<body class="bg-gray-100 text-gray-800">
    <div class="container mx-auto py-10 px-6">
        <!-- Page Header -->
        <h1 class="text-3xl font-bold text-[#003366] mb-6 text-center">Edit Patient Account</h1>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 max-w-lg mx-auto">
            <form action="{{ route('patient.update', ['patient' => $patient]) }}" method="post" class="space-y-6">
                @csrf
                @method('put')
